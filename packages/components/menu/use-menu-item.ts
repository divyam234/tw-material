...
import { HTMLNextUIProps as HTMLProps, mapPropsVariants, PropGetter } from '@nextui-org/system'
...
export type UseMenuItemProps<T extends object> = Props<T> &
  Omit<HTMLProps<'li'>, keyof Props<T>>

export function useMenuItem<T extends object>(
