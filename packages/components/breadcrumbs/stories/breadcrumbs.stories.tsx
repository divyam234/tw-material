...
import {breadcrumbItem} from "@tw-material/theme";
import {Dropdown, DropdownTrigger, DropdownMenu, DropdownItem} from "@tw-material/dropdown";
  ...
  <Breadcrumbs
    ...
    renderEllipsis={({items, ellipsisIcon, separator}) => (
      <div className="flex items-center">
        <Dropdown>
          <DropdownTrigger>
            <Button isIconOnly className="min-w-unit-6 w-unit-6 h-unit-6" size="sm">
              {ellipsisIcon}
            </Button>
          </DropdownTrigger>
