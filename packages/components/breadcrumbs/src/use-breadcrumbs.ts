import type {BreadcrumbsVariantProps, BreadcrumbsSlots} from "@tw-material/theme";
import type {AriaBreadcrumbsProps} from "@react-types/breadcrumbs";

import {Children, ReactNode, Key, ReactElement} from "react";
import {HTMLTwM3Props, mapPropsVariants, PropGetter} from "@tw-material/system";
import {breadcrumbs, SlotsToClasses} from "@tw-material/theme";
import {filterDOMProps, pickChildren, ReactRef, useDOMRef} from "@tw-material/react-utils";
...
interface Props extends HTMLTwM3Props<"nav">, AriaBreadcrumbsProps {
  /**
   * Ref to the DOM node.
   */
...
export type UseBreadcrumbsProps = Props &
  ...
  Partial<Pick<BreadcrumbItemProps, "size" | "underline" | "hideSeparator" | "disableAnimation">>;
