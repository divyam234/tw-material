import type {BreadcrumbItemVariantProps, BreadcrumbItemSlots} from "@tw-material/theme";
...
import {breadcrumbItem, SlotsToClasses} from "@tw-material/theme";
import {filterDOMProps, ReactRef, useDOMRef} from "@tw-material/react-utils";
...
interface Props
  extends Omit<HTMLTwM3Props<"li">, keyof AriaBreadcrumbItemProps>,
