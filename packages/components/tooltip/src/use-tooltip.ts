import type {PopoverVariantProps, SlotsToClasses} from "@tw-material/theme";
import type {AriaTooltipProps} from "@react-types/tooltip";
import type {OverlayTriggerProps} from "@react-types/overlays";
import type {HTMLMotionProps} from "framer-motion";
import type {OverlayOptions} from "@tw-material/aria-utils";
...
import {cn, popover} from "@tw-material/theme";
import {dataAttr} from "@tw-material/shared-utils";
import {ReactRef, mergeRefs} from "@tw-material/react-utils";
import {createDOMRef} from "@tw-material/react-utils";
import {useMemo, useRef, useCallback} from "react";
import {toReactAriaPlacement, getArrowPlacement} from "@tw-material/aria-utils";
  ...
  const getTooltipContentProps = useCallback<PropGetter>(
    () => ({
      ...
      className: slots.content({
        class: clsx(classNames?.content, "bg-inverse-surface text-inverse-on-surface", className),
      }),
    }),
