...
import type {ReactRef} from "@tw-material/react-utils";
import type {RadioGroupSlots, SlotsToClasses} from "@tw-material/theme";

import {radioGroup} from "@tw-material/theme";
...
import {filterDOMProps, useDOMRef} from "@tw-material/react-utils";
import {safeAriaLabel} from "@tw-material/shared-utils";
import {mergeProps} from "@react-aria/utils";

import {RadioProps} from "./index";
import clsx from "clsx";

interface Props extends Omit<HTMLProps<"div">, "onChange"> {
  /**
   * Ref to the DOM node.
   */
...
export type UseRadioGroupProps = Omit<Props, "defaultChecked"> &
  ...
  Partial<Pick<RadioProps, "size" | "isDisabled" | "disableAnimation" | "onChange">>;
