...
import {popover} from "@tw-material/theme";
  ...
  return (
    <div className="inline-grid grid-cols-3 gap-4">
      <Popover {...args} placement="top-start">
        <PopoverTrigger>
          <Button variant="elevated">Top Start</Button>
        </PopoverTrigger>
        {content}
      </Popover>
      ...
      <Popover {...args}>
        <PopoverTrigger>
          <Button variant="elevated">Top</Button>
        </PopoverTrigger>
        {content}
      </Popover>
      ...
      <Popover {...args} placement="top-end">
        <PopoverTrigger>
          <Button variant="elevated">Top End</Button>
        </PopoverTrigger>
        {content}
      </Popover>
      ...
      <Popover {...args} placement="bottom-start">
        <PopoverTrigger>
          <Button variant="elevated">Bottom Start</Button>
        </PopoverTrigger>
        {content}
      </Popover>
      ...
      <Popover {...args} placement="bottom">
        <PopoverTrigger>
          <Button variant="elevated">Bottom</Button>
        </PopoverTrigger>
        {content}
      </Popover>
      ...
      <Popover {...args} placement="bottom-end">
        <PopoverTrigger>
          <Button variant="elevated">Bottom End</Button>
        </PopoverTrigger>
        {content}
      </Popover>
      ...
      <Popover {...args} placement="right-start">
        <PopoverTrigger>
          <Button variant="elevated">Right Start</Button>
        </PopoverTrigger>
        {content}
      </Popover>
      ...
      <Popover {...args} placement="right">
        <PopoverTrigger>
          <Button variant="elevated">Right</Button>
        </PopoverTrigger>
        {content}
      </Popover>
      ...
      <Popover {...args} placement="right-end">
        <PopoverTrigger>
          <Button variant="elevated">Right End</Button>
        </PopoverTrigger>
        {content}
      </Popover>
      ...
      <Popover {...args} placement="left-start">
        <PopoverTrigger>
          <Button variant="elevated">Left Start</Button>
        </PopoverTrigger>
        {content}
      </Popover>
      ...
      <Popover {...args} placement="left">
        <PopoverTrigger>
          <Button variant="elevated">Left</Button>
        </PopoverTrigger>
        {content}
      </Popover>
      ...
      <Popover {...args} placement="left-end">
        <PopoverTrigger>
          <Button variant="elevated">Left End</Button>
        </PopoverTrigger>
        {content}
      </Popover>
    </div>
...
const OffsetTemplate = (args: PopoverProps) => (
  <div className="flex gap-2">
    <Popover {...args}>
      <PopoverTrigger>
        <Button>Default offset (7)</Button>
      </PopoverTrigger>
      {content}
    </Popover>
...
const WithBackdropTemplate = (args: PopoverProps) => (
  <Popover {...args}>
    <PopoverTrigger>
      <Button radius="full">Open Popover</Button>
    </PopoverTrigger>
    <PopoverContent>
      {(titleProps) => (
        <div className="px-1 py-2 w-full">
