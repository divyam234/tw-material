import type {ToggleVariantProps, ToggleSlots, SlotsToClasses} from "@tw-material/theme";
...
import {toggle} from "@tw-material/theme";
...
interface Props extends HTMLProps<"input"> {
  /**
   * Ref to the DOM node.
   */
