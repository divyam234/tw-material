import type {AutocompleteVariantProps, SlotsToClasses, AutocompleteSlots} from "@tw-material/theme";

import {
  DOMAttributes,
  HTMLTwM3Props as HTMLProps,
  mapPropsVariants,
  PropGetter,
} from "@tw-material/system";
import {autocomplete} from "@tw-material/theme";
...
import {PopoverProps} from "@tw-material/popover";
import {ListboxProps} from "@tw-material/listbox";
import {InputProps} from "@tw-material/input";
import {dataAttr} from "@tw-material/shared-utils";
import {ScrollShadowProps} from "@tw-material/scroll-shadow";
import {chain, mergeProps} from "@react-aria/utils";
import {ButtonProps} from "@tw-material/button";
import {AsyncLoadable, PressEvent} from "@react-types/shared";
import clsx from "clsx";

interface Props<T> extends Omit<HTMLProps<"input">, keyof ComboBoxProps<T>> {
  /**
   * Ref to the DOM node.
   */
