import type {CheckboxGroupSlots, SlotsToClasses} from "@tw-material/theme";
...
import {checkboxGroup} from "@tw-material/theme";
...
export type UseCheckboxGroupProps = Omit<Props, "onChange"> &
  ...
  Partial<
    Pick<
      CheckboxProps,
      | "size" | "radius" | "lineThrough" | "isDisabled" | "disableAnimation"
    >
  >;
