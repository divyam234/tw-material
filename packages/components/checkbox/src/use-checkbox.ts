import type {CheckboxVariantProps, CheckboxSlots, SlotsToClasses} from "@tw-material/theme";
...
import {checkbox} from "@tw-material/theme";
...
interface Props extends Omit<HTMLProps<"input">, keyof CheckboxVariantProps> {
  /**
   * Ref to the DOM node.
   */
...
export function useCheckbox(props: UseCheckboxProps = {}) {
  ...
  const slots = useMemo(
    ...
    [size, radius, isInvalid, lineThrough, isDisabled, disableAnimation],
  );
